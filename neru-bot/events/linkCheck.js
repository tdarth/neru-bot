...
module.exports = {
    ...
    async execute(message) {
        ...
        const level15Message = await message.reply({ flags: MessageFlags.IsComponentsV2, components: [new ContainerBuilder().addTextDisplayComponents(new TextDisplayBuilder().setContent(":x: **Level 10** is required to send gifs/links.")).addSeparatorComponents(new SeparatorBuilder()).addTextDisplayComponents(new TextDisplayBuilder().setContent("-# You can check your progress with **/level** in <#1369383513132105874>."))] })
