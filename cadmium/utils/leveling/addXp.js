...
async function addXp(serverId, userId, type, channel = null) {
    ...
    if (type == 'msg') {
        ...
        await forceAddXp(serverId, userId, serverConfig.xp_mode == 'static' ? serverConfig.xp_static : Math.floor(Math.random() * (serverConfig.xp_random_max - serverConfig.xp_random_min + 1)) + serverConfig.xp_random_min, channel);
    }
}
