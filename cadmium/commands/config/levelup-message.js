...
module.exports = {
	data: new SlashCommandSubcommandBuilder()
		...
		.addStringOption(option => option.setName('message').setDescription('Placeholders: {user} {userId} {username} {displayname} {xp} {totalXp} {oldLevel} {newLevel}').setRequired(true)),
