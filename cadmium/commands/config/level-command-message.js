...
module.exports = {
	data: new SlashCommandSubcommandBuilder()
		...
		.addStringOption(option => option.setName('message').setDescription('Placeholders: {user} {userId} {username} {displayname} {level} {xp} {nextLevelXp} {totalXp}').setRequired(true)),
